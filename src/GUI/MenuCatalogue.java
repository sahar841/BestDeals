 ...
 * @author ahmed
 */
public class MenuCatalogue extends javax.swing.JFrame {

    /**
     * Creates new form MenuCatalogue
     */
    public MenuCatalogue() {
        initComponents();
        this.setDefaultCloseOperation(MenuCatalogue.DO_NOTHING_ON_CLOSE);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuCatalogue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuCatalogue().setVisible(true);
            }
        });
    }
